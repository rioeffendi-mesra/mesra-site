...
- **QAL3 or AST shows a need.** If your [ongoing drift checks]({{ '/insights/cems-quality-assurance-chain-qal1-qal2-qal3-ast/' | relative_url }}) or the annual surveillance test indicate the calibration no longer holds, a QAL2-CVT is required.
