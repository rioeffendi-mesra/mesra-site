---
layout: post
title: "The MS 1596 revision: why Malaysia's dust standard is being rewritten — and where it's heading"
date: 2026-06-24 03:00:00
description: "Part 4 of our Reference Methods series: MS 1596, Malaysia's particulate stack-test standard, is being revised. Why the 2003 edition is being rewritten, what it is aligning to (the current ISO 9096 and EN 13284-1), and how a Malaysian Standard is actually made — with the clause-by-clause changes to follow when JSM publishes."
...
In [Part 3]({{ '/insights/ms-1596-iso-9096-en-13284-particulate-standards/' | relative_url }}) we mapped how MS 1596, ISO 9096 and EN 13284 fit together — one manual gravimetric method adopted at three levels — and we flagged that **MS 1596 is being revised**. This part is the promised follow-up: *why* it's being rewritten, and *where* it's heading. We sit on the technical committee doing that work, so a word on what this article is — and isn't:
...
<div class="lin-cols">
  <div class="lin-col ms">
    ...
    <span class="lin-code">MS 1596:2003</span>
    <span class="lin-full">Malaysia's current particulate SRM, confirmed 2013.</span>
    <dl>
      <dt>Built on</dt><dd>ISO 9096:1992 + ISO 10780.</dd>
      <dt>Low dust</dt><dd>Inaccuracy exceeds ±10% below 50 mg/m³.</dd>
      <dt>Status</dt><dd>Being revised.</dd>
    </dl>
  </div>
  <div class="lin-col iso">
    <span class="lin-tier">Aligning to</span>
    <span class="lin-code">ISO 9096:2017 · EN 13284-1</span>
    <span class="lin-full">The current international root and its low-dust refinement.</span>
    <dl>
      <dt>ISO 9096:2017</dt><dd>The general method, 20–1000 mg/m³.</dd>
      <dt>EN 13284-1</dt><dd>Purpose-built for low dust below 50 mg/m³.</dd>
      <dt>Both</dt><dd>Published standards, mapped in Part 3.</dd>
    </dl>
  </div>
  <div class="lin-col ms">
    <span class="lin-tier">After revision</span>
    <span class="lin-code">MS 1596 (new edition)</span>
    <span class="lin-full">Realigned to the current ISO edition and EN low-dust thinking.</span>
    <dl>
      <dt>Expected</dt><dd>Closer to ISO 9096:2017.</dd>
      <dt>Low dust</dt><dd>Better capability at clean-stack levels.</dd>
      <dt>Specifics</dt><dd>Confirmed on JSM publication.</dd>
    </dl>
  </div>
</div>
<p class="fig-note">The revision realigns MS 1596 to the current ISO root and the EN low-dust refinement — the same family mapped in <a href="{{ '/insights/ms-1596-iso-9096-en-13284-particulate-standards/' | relative_url }}">Part 3</a>.</p>
<figcaption>Direction of travel only. The exact content of the new edition is set by the committee and confirmed at publication.</figcaption>
</figure>
...
- **Carry the current method detail.** The [isokinetic criteria and the equal-area traverse]({{ '/insights/isokinetic-sampling-explained-stack-test/' | relative_url }}) as they stand in ISO 9096:2017, rather than the 1992 versions.
...
You don't have to wait for the gazette to act on this. The direction is already best practice: if your stack runs clean, commissioning [reference-method testing]({{ '/insights/why-cems-needs-manual-stack-tests-srm/' | relative_url }}) and [CEMS calibration]({{ '/insights/qal2-calibration-variability-test-cems/' | relative_url }}) with low-dust capability in mind — the EN 13284-1 way — means you're already measuring the way the revised standard is heading. For testers and regulators, the alignment narrows the daylight between Malaysian practice and the international editions, which makes cross-referencing methods and results more straightforward, not less.
