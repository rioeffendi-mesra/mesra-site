...
<div class="rep-rows">
  ...
  <div class="rep-row"><span class="rep-k">D</span><span class="rep-body"><span class="rep-name">Reference conditions</span><span class="rep-desc">The temperature, pressure, moisture (dry basis) and O₂/CO₂ used to correct the raw reading.</span></span></div>
