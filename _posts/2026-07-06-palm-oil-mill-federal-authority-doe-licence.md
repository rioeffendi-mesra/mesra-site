...
description: "EQA 1974 is federal law, administered by a single Director General under the Act. Why your mill's obligations trace back to that framework — not to any one locally issued document — and what to do if the two ever look inconsistent."
...
Across this series we've grounded every rule in a primary source: [the 2.5 kg/hour dust-load threshold]({{ '/insights/palm-oil-mill-cems-dust-load-threshold/' | relative_url }}) and [the periodic tiers below it]({{ '/insights/palm-oil-mill-periodic-testing-tiers-dust-load/' | relative_url }}) come from the Second Schedule of CAR 2014, and [CO's different treatment]({{ '/insights/palm-oil-mill-co-periodic-monitoring/' | relative_url }}) does too. This final part steps back from the specific numbers to answer a more basic question: where does this authority actually come from, and what should you do if a document you've been handed locally seems to say something different?
...
**Want a clear read of how the federal framework applies to your specific mill — licence included?** [Talk to us]({{ '/' | relative_url }}#contact) — we work from the Environmental Quality Act 1974, the Clean Air Regulations 2014 and the DOE CEMS Guidelines we helped write, and can help you reconcile them against your own paperwork.
