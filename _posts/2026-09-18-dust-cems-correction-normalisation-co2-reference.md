...
One clarification before going further, because the same instrument stands behind two different limits, and they are easy to run together. A transmissometer on a mill stack answers to two separate provisions of the Clean Air Regulations:

- **Opacity — Regulation 12.** This is the transmissometer's native measurement: how much light the flue gas blocks. The limit is 20% opacity (Regulation 12(1)(b)), averaged over one minute (Regulation 12(4)), and it is judged on the gas exactly as it leaves the stack — no STP, dry-basis or CO₂ referencing is applied to it.
- **Total Particulate Matter (TPM) — Regulation 13.** This is the mass concentration in mg/m³ that the control unit derives from that same optical signal once it has been calibrated. Regulation 13 sends a mill boiler to the Second Schedule (Jadual Kedua), which sets the limit at 150 mg/m³ — and, unlike opacity, this number means nothing until it has been corrected to STP, dried, and normalised to 12% CO₂.

Everything that follows is about the second one. Opacity is measured and reported as-is; TPM is the number that has to be corrected and normalised before it can be compared to its limit. That is the distinction this whole article turns on.

## What the limit is actually written against

Every emission limit has to state the conditions it applies at, or it can be gamed. Open a damper, pull in more excess air, and the same mass of dust leaving the stack is diluted into a larger gas volume — the concentration falls without a single milligram less being emitted. So the regulation fixes the conditions: report the dust *as if* the gas were dry, at 273 K and 101.3 kPa, and diluted to a fixed reference level. The basis is set by **Regulation 13**. Regulation 13(2) fixes how every limit in these Schedules is expressed: *"the emission shall be calculated in terms of mass of pollutant per volume of the waste gases (expressed as mg/m³), assuming standard conditions for temperature and pressure for dry gas (volume at 273 K, 101.3 kPa)"* — that is the STP-and-dry half of the basis, in the regulation's own words. Regulation 13 then sends fuel-burning equipment not covered by the First Schedule — where an ordinary biomass boiler, a palm oil mill's included, sits — to the **Second Schedule (Jadual Kedua)**, which supplies the rest: **"The CO₂ reference content is 12%,"** with Total Particulate Matter limited to **150 mg/m³**.
...
First, check which regime the stack is even in. The continuous-CEMS obligation is triggered when the boiler's [dust load reaches 2.5 kg/h]({{ '/insights/biomass-boiler-cems-which-industries-need-one/' | relative_url }}) — a figure read off the stack-test certificate as concentration times flow, not a desk estimate. If Total Particulate Matter for that specific premise is periodic-only under its licence, there is no continuous calibration to maintain and no permanent peripherals are needed: each periodic isokinetic test measures and corrects its own result on the day. The four-sensor question only bites where continuous monitoring applies. And it is a Total Particulate Matter question throughout: opacity under Regulation 12 is reported just as the transmissometer measures it, while it is the TPM value under Regulation 13 that must be corrected to STP, dried and normalised to 12% CO₂ before it can be judged.
...
<div class="related">
  ...
  <ul>
    ...
    <li><a href="https://www.doe.gov.my/en/environmental-quality-clean-air-regulations-2014/" target="_blank" rel="noopener">Environmental Quality (Clean Air) Regulations 2014 [P.U.(A) 151]</a> — Department of Environment Malaysia (Regulation 12, opacity; Regulation 13 and the Second Schedule, Total Particulate Matter)</li>
